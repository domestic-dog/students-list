...
<html lang="en" dir="ltr">
  ...
  <div class="form-group">
    ...
    <input  class="form-control" id="exampleFormControlInput1" name="firstname" aria-describedby="emailHelp" placeholder="Вася">
    ...
    <input  class="form-control" id="exampleFormControlInput1" name="surname" aria-describedby="emailHelp" placeholder="Иванов">
  ...
  <div class="form-group">
    ...
    <input  class="form-control" type="email" id="exampleFormControlInput1" name="email" aria-describedby="emailHelp" placeholder="0020">
    <small id="emailHelp" class="form-text text-muted">Ваш email</small>
  </div>
            <div class="form-group">
                <label for="exampleFormControlInput1">Группа</label>
                <input  class="form-control" id="exampleFormControlInput1" name="groups" aria-describedby="emailHelp" placeholder="0020">
                <small id="emailHelp" class="form-text text-muted">Ваша группа</small>
            </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Баллы</label>
    <input  class="form-control" id="exampleFormControlInput1" name="points" aria-describedby="emailHelp" placeholder="300">
